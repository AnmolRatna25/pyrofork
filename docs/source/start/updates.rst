...
:doc:`Invoking API methods <invoking>` sequentially is one way to use PyroRatnaGram. This page deals with Telegram updates
and how to handle new incoming messages or other events in PyroRatnaGram.
