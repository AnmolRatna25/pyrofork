...
Serializing means converting a PyroRatnaGram object, which exists as Python class instance, to a text string that can be
easily shared and stored anywhere. PyroRatnaGram provides two formats for serializing its objects: one good looking for
...
.. tip::
    ...
    have done that above just to show you how to explicitly convert a PyroRatnaGram object to JSON.
